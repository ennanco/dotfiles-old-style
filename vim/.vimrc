...
Plugin 'scrooloose/nerdtree'              " NERDTree to explore directory
Plugin 'tpope/vim-fugitive'               " Git integration plugin
Plugin 'tmhedberg/SimpylFold'             " Easy folding to hide funtions
Plugin 'tpope/vim-surround'               " Complete the bracket
Plugin 'tpope/vim-repeat.git'             " maps . to repeat last command
Plugin 'bronson/vim-trailing-whitespace'  " Mark as incorrect any space
Plugin 'junegunn/fzf', { 'dir': '~/.fzf', 'do': './install --all' } " Fuzzy finder for files command :Files
Plugin 'junegunn/fzf.vim'                 " Counter part for fzf
"Plugin 'jreybert/vimagit'                "a way to control the git
"Plugin 'bling/vim-airline'               "a easy line and very light forked from powerline with possibilities to personalize
Plugin 'tpope/vim-commentary'             "comment multiple lines, paragraphs or sections by using 'gc'
"Plugin 'vifm/vifm.vim'                   "A file manager integrated in vim

"Plugin 'terryma/vim-multiple-cursors'     " Multiple cursor with crtl-n and crtl-p
